                ...
                <table id="billingTable" class="display">
                    <thead>
                        <tr>
                            ...
                            <th class="border">ค่าเฟอร์นิเจอร์</th>
                            <th class="border">ค่าห้อง</th>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr onclick="goToEditPage('<?= htmlspecialchars($row['room_number']); ?>')">
                                ...
                                <td class="border"><?php echo $row["electricity_cost"] ?></td>
                                <td class="border"><?php echo $row["water_cost"] ?></td>
                                <td class="border"><?php echo $row["furniture_cost"] ?></td>
                                <td class="border"><?php echo $row["room_cost"] ?></td>
                                <td class="border"><?php echo $row["other_cost"] ?></td>
                                <td class="border"><?php echo $row["bill_date"] ?></td>
                                <td class="border">
                                    <?php
                                    $statusClass = '';
